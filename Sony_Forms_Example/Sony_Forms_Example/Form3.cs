...
namespace Sony_Forms_Example
{
    public partial class Form3 : Form
    {
        ...
        {
            UPbut.Image = Sony_Forms_Example.Properties.Resources.arrowu_hover;
        }

        private void UP_MouseLeave(object sender, EventArgs e)
        {
            UPbut.Image = Sony_Forms_Example.Properties.Resources.arrowu;
        }
        ...
        {
            Leftbut.Image = Sony_Forms_Example.Properties.Resources.arrowl_hover;
        }

        private void Left_MouseLeave(object sender, EventArgs e)
        {
            Leftbut.Image = Sony_Forms_Example.Properties.Resources.arrowl;
        }
        ...
        {
            Rightbut.Image = Sony_Forms_Example.Properties.Resources.arrowr_hover;
        }

        private void Right_MouseLeave(object sender, EventArgs e)
        {
            Rightbut.Image = Sony_Forms_Example.Properties.Resources.arrowr;
        }
        ...
        {
            Downbut.Image = Sony_Forms_Example.Properties.Resources.arrowd_hover;
        }

        private void Down_MouseLeave(object sender, EventArgs e)
        {
            Downbut.Image = Sony_Forms_Example.Properties.Resources.arrowd;
        }
        ...
        {
            Enterbut.Image = Sony_Forms_Example.Properties.Resources.enter_hover;
        }

        private void Enter_MouseLeave(object sender, EventArgs e)
        {
            Enterbut.Image = Sony_Forms_Example.Properties.Resources.enter;
        }
